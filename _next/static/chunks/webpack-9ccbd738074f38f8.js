!(function () {
  ...
  (d.m = a),
    ...
    (d.f.j = function (e, t) {
      ...
      if (0 !== n) {
        if (n) t.push(n[2]);
        else if (/^(272|367|837)$/.test(e)) i[e] = 0;
        else {
...
(function () {
  ...
  s.setAttribute("data-deployment-id", "dpl_5SSCkv6Fs4Ab1vqrGQLCTCSJZBHK");
...
(function () {
  ...
  s.setAttribute("data-explicit-opt-in", "true");
  s.setAttribute("data-cookie-opt-in", "true");
  s.setAttribute("data-deployment-id", "dpl_3wZZbAQMvD9MogAXjHHvwbKrWgDn");
  (document.head || document.documentElement).appendChild(s);
})();
